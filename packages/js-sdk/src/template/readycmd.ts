 ...
 * @example
 * ```ts
 * import { Template, waitForPort } from 'moru'
 *
 ...
 * @example
 * ```ts
 * import { Template, waitForURL } from 'moru'
 *
 * const template = Template()
 *   .fromNodeImage()
 ...
 * @example
 * ```ts
 * import { Template, waitForProcess } from 'moru'
 *
 * const template = Template()
 *   .fromBaseImage()
 ...
 * @example
 * ```ts
 * import { Template, waitForFile } from 'moru'
 *
 * const template = Template()
 *   .fromBaseImage()
 ...
 * @example
 * ```ts
 * import { Template, waitForTimeout } from 'moru'
 *
 * const template = Template()
 *   .fromNodeImage()
